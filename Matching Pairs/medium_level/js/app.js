...
let cardImages = ['./cardImg/jerry.jpg' , './cardImg/tom.jpg' , './cardImg/bheem.jpg', './cardImg/oggy.jpg' ,'./cardImg/doremon.jpg' , './cardImg/shinchan.jpg' ,'./cardImg/jerry.jpg' , './cardImg/tom.jpg' , './cardImg/bheem.jpg', './cardImg/oggy.jpg' ,'./cardImg/doremon.jpg' , './cardImg/shinchan.jpg' ]
let visibleCard;
let firstCard;
let secondCard;
  ...
  function saveScore() {
    ...
    if (playerName)
    {
        ...
        if (age)
        {
            ...
            var scoresRef = database.ref('Matching Pairs - Medium');
