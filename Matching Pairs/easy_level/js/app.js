...
let cardImages = ['./cardImg/tom.jpg' , './cardImg/bheem.jpg','./cardImg/doremon.jpg','./cardImg/tom.jpg' ,'./cardImg/bheem.jpg','./cardImg/doremon.jpg']
let visibleCard;
let firstCard;
let secondCard;
...
function saveScore() {
    ...
    if (playerName)
    {
        ...
        if (age)
        {
            ...
            var scoresRef = database.ref('Matching Pairs - Easy');
